...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="./Math_Reasoning_in_Latent_Space/hol/output/model.pt", help="Path to save/load model")
    parser.add_argument("--results_path", type=str, default="./Math_Reasoning_in_Latent_Space/hol/output/results.pt", help="Path to save/load results")
    parser.add_argument("--output_dir", type=str, default="./Math_Reasoning_in_Latent_Space/hol/output", help="Directory to save visualizations")
